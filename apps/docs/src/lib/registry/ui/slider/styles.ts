...
export const slider = tv({
    ...
    variants: {
        ...
        radius: {
            ...
            sm: {
                thumb: 'rounded-[calc(theme(borderRadius.md)/2)] after:rounded-[calc(theme(borderRadius.md)/3)]'
            },
            md: {
                thumb: 'rounded-[calc(theme(borderRadius.lg)/2)] after:rounded-[calc(theme(borderRadius.lg)/3)]'
            },
            lg: {
                thumb: 'rounded-[calc(theme(borderRadius.xl)/1.5)] after:rounded-[calc(theme(borderRadius.xl)/2)]'
            },
            full: {
